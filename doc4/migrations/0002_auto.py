...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field repos on 'Package'
        db.create_table(u'doc4_packages_repos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('package', models.ForeignKey(orm['doc4.package'], null=False)),
            ('repository', models.ForeignKey(orm['doc4.repository'], null=False))
        ))
        db.create_unique(u'doc4_packages_repos', ['package_id', 'repository_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field repos on 'Package'
        db.delete_table('doc4_packages_repos')
